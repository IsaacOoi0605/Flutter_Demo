    ...
    return ValueListenableBuilder(
      builder: (context, value, g) {
        return MaterialApp(
          ...
          routes: {
            '/': (context) => CarouselDemoHome(),
            '/basic': (context) => BasicDemo(),
            '/nocenter': (context) => NoCenterDemo(),
            '/image': (context) => ImageSliderDemo(),
            '/complicated': (context) => ComplicatedImageDemo(),
            '/enlarge': (context) => EnlargeStrategyDemo(),
            '/manual': (context) => ManuallyControlledSlider(),
            '/noloop': (context) => NoonLoopingDemo(),
            '/vertical': (context) => VerticalSliderDemo(),
            '/fullscreen': (context) => FullscreenSliderDemo(),
            '/ondemand': (context) => OnDemandCarouselDemo(),
            '/indicator': (context) => CarouselWithIndicatorDemo(),
            '/prefetch': (context) => PrefetchImageDemo(),
            '/reason': (context) => CarouselChangeReasonDemo(),
            '/position': (context) => KeepPageviewPositionDemo(),
            '/multiple': (context) => MultipleItemDemo(),
            '/zoom': (context) => EnlargeStrategyZoomDemo(),
          },
        );
      },
